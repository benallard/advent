...
fn test1(){
    ...
    assert_eq!(43210, get_max("3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0", 0, 5));
    assert_eq!(54321, get_max("3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0", 0, 5));
...
fn test2(){
    ...
    assert_eq!(139629729, get_max("3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5", 5, 10));
